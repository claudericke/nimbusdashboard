                    ...
                    <?php if (!empty($tickets)): ?>
                        <div class="table-responsive">
                            <table class="table-custom">
                                <thead>
                                    <tr>
                                        <th style="width:60px">Resolve</th>
...
<div class="modal fade" id="closeTicketModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form method="POST" action="/tickets/close" class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title text-accent-rose">Decommission Mission</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body p-4">
                <p class="text-white fs-5">Confirm resolution for:</p>
                <p class="h4 fw-bold text-accent-emerald mb-4" id="close_ticket_name"></p>
                <p class="text-secondary small">This will signal completion and archive the transmission.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-link text-decoration-none text-secondary fw-bold"
                    data-bs-dismiss="modal">ABORT</button>
                <button type="submit" class="btn-complete-graphic">RESOLVE MISSION</button>
            </div>
        </form>
    </div>
</div>
